...
vector <vector <const wchar_t*> > ivector = {{L"1",L"2",L"3",L"4"},
               ...
               {L"9",L"10",L"11",L"12"}, 
               {L"13",L"14",L"15",L"16"} };
const wchar_t* buf[4][4] = { {L"test",L"string",L"maks",L"car"},{L"word",L"world",L"don't",L"know"},
                            {L"tree",L"project",L"prog",L"C++"},{L"winapi",L"class",L"name",L"task"} };
...
void fillWindow(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    HFONT font = CreateFont(rowH, columnW/7, 0, 0, FW_DONTCARE, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
